...
namespace Avalia_Pesquisa
{
    public class CloudDataStore : IDataStore<Item>
    {
        ...
        //            {
        //                var dadosLocal = conexao.Query<Config>("SELECT * FROM Municipio_Localidade Where idLocalidade=?", local.IdLocalidade);

        //                if (dadosLocal.Count == 0)
        //                {
        //                    conexao.Query<Config>("INSERT INTO Municipio_Localidade (IdLocalidade,IdMunicipio,Descricao) Values(?,?,?)",
